...
return [
    ...
    */
    ...
    'custom' => [
        'document' => [
            'driver' => 'The document has already been taken.',
            'user'   => 'The document has already been taken.',
        ],
        'phone' => [
            'driver' => 'The phone has already been taken.',
        ],
        'email' => [
            'driver' => 'The email has already been taken.',
        ],
    ],
